...
distMin Vacio = 0
distMin (AB r Vacio Vacio) = 0  -- nodo hoja
distMin (AB r Vacio t2)    = 1 + distMin t2
distMin (AB r t1 Vacio)    = 1 + distMin t1
distMin (AB r t1 t2)       = 1 + min (distMin t1) (distMin t2)

{- Función: cuadradoAB
   Descripción: Dado un  ́arbol de enteros devuelve el  ́arbol con los cuadrados de 
   cada uno de los elementos en la misma posición.
   Uso: cuadradoAB (AB 7 (AB 1 Vacio Vacio ) (AB 8 Vacio Vacio)) = (AB 49 (AB 1 Vacio Vacio ) (AB 64 Vacio Vacio)) 
-}

cuadradoAB :: Arbol Int -> Arbol Int
cuadradoAB Vacio =  Vacio
cuadradoAB (AB r t1 t2) = AB (r*r) (cuadradoAB t1) (cuadradoAB t2)
