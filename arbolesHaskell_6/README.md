...
Un BST balanceado autómaticamente, la diferencia de su altura entre subárboles izquierdo y derecho de cualquier nodo es como máximo 1

![BST](balance.jpg)

## Árbol c-balanceado

_Un árbol binario $T$ es balanceado si y solo si para todo vértice de T se cumple que la distancía máxima al vertice a algunas de sus hojas es a lo más $c$ veces la distancía mínima del vértice a alguna de sus hojas, donde $c$ es una constante fija._

  $$\text{d_max}(v) \le c \cdot \text{d_min}(v)$$

Donde:

La distancía el número de aristas (conexiones) que hay que recorrer para ir de un vértice a otro sea máximo o mínimo



## Visualización de árboles.

- Visualización de un árbol binario de búsqueda y sus operaciones:
  
   [Binary Search Tree](https://www.cs.usfca.edu/~galles/visualization/BST.html)


- Visualización de un árbol AVL:
