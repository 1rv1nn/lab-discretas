...
En Haskell la notación de Lista es representada como [a], que significa una lista de elementos de tipo a tiene dos contructores:

1. [] (La lista vacia): 
2. : (cons): Operador infijo que asocia a la derecha y toma un elemento, una lista y construye una nueva lista con el elementos añadido al principio. Por ejemplo 1:[2,3], crea la lista [1,2,3]
...
Tambien las listas suelen ser introducidas al lenguaje bajo el modulo `Data.List` que nos provee un conjunto extenso de funciones diseñadas específicamente para manipular esta estructura tales como `intersperse`, `nub`, `partition`, `sort`, etc. (NO UTILIZAR EN ESTE CURSO)
